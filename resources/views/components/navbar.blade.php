<nav class="h-10 w-full bg-gray-100 px-8 text-gray-600 sticky top-0 z-10">
                ...
                <div
                    ...
                    @auth
                        <div class="border-b border-gray-100">
                            ...
                            <a href="#" class="block px-4 py-2 text-xs text-gray-700 hover:bg-gray-50">Mes
                                réservations</a>
                            <a href="#" class="block px-4 py-2 text-xs text-gray-700 hover:bg-gray-50">Mes favoris</a>
                        </div>
                    @endauth
